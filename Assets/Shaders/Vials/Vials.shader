   ...
   // The _BaseColor variable is visible in the Material's Inspector, as a field
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			void InitalizeSurfaceData(v2f IN, out SurfaceData surfaceData){
			...
			void InitializeInputData(v2f input, half3 normalTS, out InputData inputData) {
				...
				*/
				...
				inputData.normalizedScreenSpaceUV = GetNormalizedScreenSpaceUV(input.vertexCS);
            ...
            v2f vert(appdata IN)
            {
				...
				OUT.vertexCS = positionInputs.positionCS;
